Admin tasdiqlmasayam manbu joyga oʻtyspti elon berish joyiga 


Keyin tugmalar rangli boʻlishi kerak bu tugmalar oq kulrang buyurtma berish yordam degan tugmalar telgram yangi ranglar qoʻshganku 3 ta shunqa boʻlsin 
...
async def start_ad(message: Message, state: FSMContext):
    ...
    # Admin hali tasdiqlamagan e'lon bor
    if pending:
