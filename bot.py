...
# Sayt admin chatiga /verify_XXXXXX yoki /verify_XXXXXX_CHATID yuboradi
# Bot DB dan tekshirib "ok", "no" yoki "used" deb javob beradi
@router.message(F.text.regexp(r'^/verify_\d{6}'))
async def verify_site_code(message: Message):
    # Faqat admin chatida ishlaydi
...
# Eski /check_ handler ham qoldirish (zaxira)
